        ...
        <div class="section-body">
                	...
                	<div class="card">
                  		...
                  		<div class="card-body">
                  			<div class="col-md-12 col-lg-12 col-xs-12">
                  				<form method="post"	action="<?php echo base_url()?>index.php/daybookController/installmentListReport" enctype="multipart/Form-data" >
                  					<div class="row">
           ...
           <!--     												</div>-->
											...
											<div class="col-xs-6  col-md-6 col-lg-6">
                                                    <div class="form-group row">
                                                     <div class="col-md-12">
													<button type="submit" class="btn btn-primary" style="margin-left:800px;"><i class="fas fa-check">&nbsp;OK</i></button>
