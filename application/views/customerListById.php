                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                       ...
                       <?php  }}?>
                    	...
                    	<form method="post"	action="<?php echo base_url()?>index.php/customer/getCustomerById" enctype="multipart/Form-data" >
                    	     <div class="col-md-12 col-lg-12 col-xs-12">
										    <div class="row">
											<div class="col-xs-6 col-md-6 col-lg-6">
                                     ...
                                     <tr>
                                       ...
                                       $aginfo= $this->db->get("agent_info");
                                        ...
                                        <td><?php echo $aginfo->row()->name."     "."[".$aginfo->row()->username."]";?> </td>
                                         <?php $this->db->where("reff_id",$finalData[$key]['parentID']);
                                       $custinfo= $this->db->get("customer_info");
                                        ?>
                                        <td><?php echo $custinfo->row()->name."     "."[".$custinfo->row()->username."]";?></td>
                                    </tr>
                                  <?php
                                   $i++; endforeach;
                                  ?>
