                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          $credit=0;    
                           if($gdbd->num_rows()>0){
                                ...
                                <?php $this->db->where("id",$gt->paid_to);
                                     $aginfo=$this->db->get("agent_info")->row();?>
                                <td><?php if($gt->paid_to==1){ echo "BHOOMISUKH";}else{ echo $aginfo->name; }?></td>
                        ...
                        <tfoot>
							<tr>
								...
								<td></td>
								<td></td>
								<td align="right"><strong>Total Commision</strong></td>
								<td></td>
							
								<td></td>
								<?php $com= $credit*14/100;?>
								<td style="color: red"><?php echo $com; ?></td>
								<td></td>
								<td></td>
							</tr>
						</tfoot>
