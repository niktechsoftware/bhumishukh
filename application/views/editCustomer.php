...
$aginfo=$this->db->get('customer_info');
	?>
				...
				<div class="col-xs-12 col-md-12 col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4>Edit Customer Registration Form</h4>

						</div>
						<form method="post"	action="<?php echo base_url()?>index.php/customer/editCust" enctype="multipart/Form-data" >
													...
													<div class="col-md-7">
														<div class="form-group">
															<input type="text" class="form-control"
																value="<?php echo $aginfo->row()->name;?>" name="name"
