                       ...
                       if($aginfo->num_rows()>0){
                        ...
                        ?>
                          <tr>
                            ...
                            <a href="<?php echo base_url();?>index.php/apanel/editagent_registration/<?php echo $data->id;?>">
                            <i class="fa fa-edit" style="color:white"></i>
                            </a></button></td>
                             <td><button type="button" class="btn btn-danger">
                            <a href="<?php echo base_url();?>index.php/apanel/deleteAgent/<?php echo $data->id;?>">
