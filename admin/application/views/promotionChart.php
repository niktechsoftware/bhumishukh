                       ...
                       <th>Action</th>
                              ...
                              $j =1; foreach($phndetails->result() as $phnd): ?>
                                 <tr>
                                  ...
                                  <td><input class="form-control" type="text" id="ad<?php echo $phnd->id;?>" name="year1" value="<?php echo $phnd->advisor;?>"></td>
                                  <td><input class="form-control" type="text" id="pr<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->promoter;?>"></td>
                                  <td><input class="form-control" type="text" id="fo<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->f_o;?>"></td>
                                  <td><input class="form-control" type="text" id="so<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->s_o;?>"></td>
                                  <td><input class="form-control" type="text" id="co<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->c_o;?>"></td>
                                   <td><input class="form-control" type="text" id="st<?php echo $phnd->id;?>" name="year1" value="<?php echo $phnd->star;?>"></td>
                                  <td><input class="form-control" type="text" id="sil<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->silver;?>"></td>
                                  <td><input class="form-control" type="text" id="gold<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->gold;?>"></td>
                                  <td><input class="form-control" type="text" id="ruby<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->ruby;?>"></td>
                                  <td><input class="form-control" type="text" id="em<?php echo $phnd->id;?>"name="year1" value="<?php echo $phnd->emrald;?>"></td>
                                  <td><input class="form-control" type="text" id="diamond<?php echo $phnd->id;?>" name="year1" value="<?php echo $phnd->diamond;?>"></td>
