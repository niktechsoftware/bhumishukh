           ...
           <li><a class="nav-link" href="<?php echo base_url();?>index.php/customer/customerList">Search Customer</a></li>
             ...
             <!-- <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="<?php echo base_url();?>index.php/apanel/deliverd/">Add New </a></li>
                <li><a class="nav-link" href="<?php echo base_url();?>index.php/apanel/view_list/">View List</a></li>
                <li><a class="nav-link" href="<?php echo base_url();?>index.php/apanel/view_list/">Tree View</a></li>
              </ul>
            </li>
          <li class="dropdown">
