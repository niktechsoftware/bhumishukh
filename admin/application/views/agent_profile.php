              ...
              <div class="col-12 col-md-12 col-lg-4">
                <div class="card author-box">
                  <div class="card-body">
					...
					<?php $this->db->where("agent_id",$crecord->row()->id);
            $din=$this->db->get("agent_doc_info");
           // if($din->num_rows()>0){
          if(strlen($din->row()->image > 0)):?>
                        ...
                        <form method="post" class="needs-validation" action="<?php echo base_url();?>index.php/adminController/admin_edit_profile" enctype="multipart/form-data"   >
                          ...
                          <div class="card-body">
                            <div class="row">
							 ...
							 <div class="row">
                 <div class="form-group col-md-3 col-12"><label>Aadhar Number</label></div>
                              <div class="form-group col-md-3 col-12"><input type="text" class="form-control" name="state" value="<?php echo $din->row()->aadhar_number; ?>" readonly>
                                <div class="invalid-feedback">Please fill in the last name </div>
                              </div>
							<div class="form-group col-md-2 col-12"><label>Aadhar Image</label></div>
							  <div class="form-group col-md-4 col-12">
                   <img src="<?php echo base_url();?>assets/img/doc/<?php echo $din->row()->image; ?>" alt="" width="100" height="120">
                                <div class="invalid-feedback">Please fill in the first name</div>
                              </div>
                             
                            </div>
					 <div class="row">
                 <div class="form-group col-md-3 col-12"><label>Pan Number</label></div>
                              <div class="form-group col-md-3 col-12"><input type="text" class="form-control" name="state" value="<?php echo $din->row()->pan_card; ?>" readonly>
                                <div class="invalid-feedback">Please fill in the last name </div>
                              </div>
              <div class="form-group col-md-2 col-12"><label>PanCard Image</label></div>
                <div class="form-group col-md-4 col-12">
                   <img src="<?php echo base_url();?>assets/img/doc/<?php echo $din->row()->pan_image; ?>" alt="" width="100" height="120">
                                <div class="invalid-feedback">Please fill in the first name</div>
                              </div>
                             
                            </div>
                             <div class="row">
                        <div class="form-group col-md-3 col-12"><label>Account Number</label></div>
                                    <div class="form-group col-md-3 col-12"><input type="text" class="form-control" name="state" value="<?php echo $din->row()->account_number; ?>" readonly>
                                <div class="invalid-feedback">Please fill in the last name </div>
                              </div>
                          <div class="form-group col-md-2 col-12"><label>Passbook Image</label></div>
                            <div class="form-group col-md-4 col-12">
                               <img src="<?php echo base_url();?>assets/img/doc/<?php echo $din->row()->passbook_image; ?>" alt="" width="100" height="120">
                                <div class="invalid-feedback">Please fill in the first name</div>
                              </div>
